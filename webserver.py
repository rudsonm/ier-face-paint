...
def process_image(image_url):
    ...
    Image.fromarray(mat).save('images/emotionfull.png')

class Default:
    def on_get(self, req: falcon.Request, resp: falcon.Response):
        if req.params and req.params['url']:
            process_image(req.params['url'])
        resp.status = falcon.HTTP_OK
        resp.content_type = falcon.MEDIA_HTML
        resp.body = '<center><img src="/images/emotionfull.png" /></center>'


api = falcon.API()
api.add_route('/', Default())
api.add_static_route('/images', '/home/viniciusas/Projects/Class/ier-face-paint/images')